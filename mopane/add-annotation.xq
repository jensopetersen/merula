...
let $annotation-base-text-version := il2so:generate-base-text($new-annotation/(* except a8n-target), $wit)
let $annotation-target-text-version := so2il:generate-target-text($new-annotation/(* except a8n-target))
