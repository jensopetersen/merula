...
let $a8ns := 
    ...
    return
        if (
            $a8n-range = 0 
                and 
            $a8n/following-sibling::a8n-annotation[sum(a8n-target/a8n-offset) = $a8n-offset][a8n-target/a8n-range/number() = $a8n-range] 
                and
            not($a8n/preceding-sibling::a8n-annotation[sum(a8n-target/a8n-offset) = $a8n-offset][a8n-target/a8n-range/number() = $a8n-range])
        )
        then 
            <zero-range-cluster>{$a8n, $a8n/following-sibling::a8n-annotation[sum(a8n-target/a8n-offset) = $a8n-offset][a8n-target/a8n-range/number() = 0]}</zero-range-cluster>
        else 
            if (
                $a8n/preceding-sibling::a8n-annotation[sum(a8n-target/a8n-offset) = $a8n-offset][a8n-target/a8n-range/number() = $a8n-range]
                    or
                $a8n/following-sibling::a8n-annotation[sum(a8n-target/a8n-offset) = $a8n-offset][a8n-target/a8n-range/number() = $a8n-range]
            )
            then ()
