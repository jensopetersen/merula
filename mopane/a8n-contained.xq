...
<a8ns>
    ...
    <a8n n="i"><offset>12</offset><range>1</range></a8n>
</a8ns>


let $results := 
    for $a8n-base in $a8ns/a8n
    ...
    return
        ...
        then ()
            ...
            if (
                ...
                and
                $target-offset < $base-offset + $base-range
                and
                $target-offset + $target-range < $base-offset + $base-range
                )
            then
